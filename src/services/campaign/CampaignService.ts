...
export default class CampaignService {
  ...
  public static searchCampaigns(
    ...
    if (pageRequest.URL) {
      ...
      Web.get(
        "/api/v1/campaign/search/searchCampaign?name=" +
          query +
          "&desc=" +
          query,
        successHandler,
  ...
  public static getCampaignDetails(
    ...
    Web.get(
      "/api/v1/campaign_request/" + campaignId,
      successHandler,
      errorHandler
    );
  }
